...
$sql="select * from players ORDER BY gscored DESC";
$query=mysqli_query($con,$sql);

echo "<table border=1>";
echo "<tr><th>Firstname</th><th>Secondname</th><th>Club</th><th>Goals</th></tr>";
while ($result=mysqli_fetch_array($query)) 
{

    echo "<tr><td>$result[3]</td><td>$result[4]</td><td>$result[6]</td><td>$result[8]</td></tr>";
}
echo "</table>";
?>
