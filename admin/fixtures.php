...
<form method="POST" action="" class="login">
    <h2>Team Registration Form</h2>
        ...
        <input class="form-control" type="text" name="coachname" placeholder="Coach Name">
        <input class="form-control" type="text" name="ownername" placeholder="Owner Name">
        <input class="form-control" type="text" name="admin" placeholder="Admin">
        <input class="form-control" type="text" name="stadium" placeholder="Stadium">
        <select class="form-control" name="homecounty">
...
mysqli_close($con);
?>
<?php include("../footer.php") ?> span style="color:red">*</span> are required.<br>

<label>RegNo.<span style="color: red">*</span><input class="form-control" type="text" name="regno"></label><br>
<label>Surname<span style="color: red">*</span><input class="form-control" type="text" name="surname"></label><br>
<label>Firstname<span style="color: red">*</span><input class="form-control" type="text" name="firstname"></label><br>
<label>Email<span style="color: red">*</span><input class="form-control" type="text" name="email"></label><br>
<label>Password<span style="color: red">*</span><input class="form-control" type="password" name="password1"></label><br>
<label>Re-Enter Password<span style="color: red">*</span><input  class="form-control" type="password" name="password2"></label><br>
<input submit class="btn btn-primary" type="submit" name="Submit" value="Submit">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['password1'] == $_POST['password2']) {
        $hash_pass = md5($password);
        $sql = "INSERT INTO student(regno, surname, firstname, email,password)
VALUES ('$regno', '$surname', '$firstname', '$email','$hash_pass')";
    } else {
        echo "Passwords do not match";
    }
    $query = mysqli_query($con, $sql);
